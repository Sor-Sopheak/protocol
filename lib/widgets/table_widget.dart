      ...
      return DragAndDropList(
        header: Column(
         ...
         children: <DragAndDropItem>[
          DragAndDropItem(child: _buildListItem('Sub $index.1')),
          DragAndDropItem(child: _buildListItem('Sub $index.2')),
          DragAndDropItem(child: _buildListItem('Sub $index.3')),
        ],
      );
    });
  }
      ...
      children: [
        const DragHandle(
          child: Padding(
            ...
            child: Icon(
              Icons.menu,
              color: Color.fromARGB(255, 3, 155, 231),
            ),
          ),
        ),
        Expanded(
